    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                navigationIcon = {
                    IconButton(onClick = { /* Abrir menu lateral */ }) {
        ...
        Box(modifier = Modifier
            ...
            Column(
                ...
                LazyVerticalGrid(
                    ...
                    items(listOf("Site", "Aplicativo", "Teclados de Acesso Físico")) { categoria ->
                        Card(
            ...
            FloatingActionButton(
                ...
                modifier = Modifier
                    ...
                    .offset(y = 55.dp)
                    .size( 75.dp)// sobe um pouco o botão
            ) {
                Icon(Icons.Default.Fullscreen, contentDescription = "Central Action", tint = Color.White)
            }
